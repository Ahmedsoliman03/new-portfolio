    ...
    <section className="py-20 px-4 relative" ref={ref}>
      <div className="md:container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {contactInfo.map((item, index) => (
            ...
            >
              <Card 
                className={`p-6 bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/50 transition-all duration-300 group hover:shadow-glow ${
      ...
      >
        <p className="text-muted-foreground">
          © {new Date().getFullYear()} Ahmed Mohamed. Built with React & Framer Motion.
        </p>
      </motion.div>
    </section>
  );
